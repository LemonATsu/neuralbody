...
class Dataset(data.Dataset):
    ...
    def _init_dataset(self):
        if self.subject.startswith('Weipeng'):
            self._dataset = h5py.File(os.path.join(self.data_root, 'MonoPerfCap', self.subject, 'Weipeng_NB_h5py.h5'))
        elif self.subject.startswith('Nadia'):
            self._dataset = h5py.File(os.path.join(self.data_root, 'MonoPerfCap', self.subject, 'Nadia_NB_h5py.h5'))
        else:
